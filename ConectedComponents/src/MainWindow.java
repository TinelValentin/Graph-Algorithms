       ...
       Neorientat.setBounds(150,330,250,70); 
        ...
        Neorientat.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
             panouB.setVisible(false);
             f.remove(panouB);
              f.add(new ComponeneteTariConexe() );
             f.repaint();
